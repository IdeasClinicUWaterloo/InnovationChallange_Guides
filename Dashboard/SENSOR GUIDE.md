...
* [parseArduinojson()](https://git.uwaterloo.ca/EngineeringIdeasClinic/healthhub/-/blob/master/Dashboard/Python%20Code/sensorHelper.py?ref_type=heads#L34-40) - loads line from Serial Monitor as json string if the line starts with "{". 
* **Color Sensor:**
